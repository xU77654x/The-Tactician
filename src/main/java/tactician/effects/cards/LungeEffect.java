...
public class LungeEffect extends AbstractGameEffect {
	private float x;
	private float y;
	...
	public LungeEffect(float x, float y, String soundKey, float volume, Color color) {
		...
		this.duration = 0.3F;
		this.scaleMultiplier = MathUtils.random(0.1F, 0.4F);
