...
public class VantagePower extends AbstractPower {
	...
	private static final Texture tex84 = TextureLoader.getTexture(powerPath("large/Vantage_Large.png"));
	private static final Texture tex32 = TextureLoader.getTexture(powerPath("Vantage.png"));
